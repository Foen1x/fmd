...
<head>
	...
	<title><%="zh".equalsIgnoreCase(lang) ? "数据模型管理" : "BO Manager"%></title>
	...
	<link rel="stylesheet" href="<%=path%>/css/bomanager.css">
	...
	<script src="<%=path%>/js/bomanager/bomanager_i18n_<%=lang%>.js"></script>
...
<script src="<%=path%>/js/bomanager/bomanager.js"></script>
<script>

ctxpath = "<%=path%>";
bom.loginName = "<%=loginName%>";
bom.displayName = "<%=displayName%>";

bom.lang = '<%=lang%>';
bom.imagepath = ctxpath + '/images/';
